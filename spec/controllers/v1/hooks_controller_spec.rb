...
describe V1::HooksController do
  ...
  # V1::HooksController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hook as @hook" do
        ...
        post :create, {:hook => { "name" => "invalid value" }}, valid_session
        assigns(:hook).should be_a_new(Hook)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hook" do
        ...
        Hook.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => hook.to_param, :hook => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the hook as @hook" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Hook.any_instance.stub(:save).and_return(false)
        put :update, {:id => hook.to_param, :hook => { "name" => "invalid value" }}, valid_session
        assigns(:hook).should eq(hook)
      end
